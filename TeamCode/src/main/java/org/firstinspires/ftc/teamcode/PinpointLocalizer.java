...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 97599.09103366017; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -177378.4083152241; // x position of the perpendicular encoder (in tick units)
    }
